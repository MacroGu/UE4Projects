...
ASlAiHandHammer::ASlAiHandHammer()
{
	...
	BaseMesh->SetRelativeLocation(FVector(0.4f, 0.4f, 0.4f));

	ExtendMesh->SetRelativeLocation(FVector(33.f, 1.f, 3.f));
	ExtendMesh->SetRelativeRotation(FRotator(0.f, -90.f, -90.f));
	ExtendMesh->SetRelativeLocation(FVector(0.4f, 0.4f, 0.4f));

	// 设置碰撞体属性
	AffectionCollision->SetRelativeLocation(FVector(26.f, 1.f, 3.f));
	AffectionCollision->SetRelativeScale3D(FVector(0.22f, 0.44f, 0.31f));
